...
import com.ivovnianko.island.classes.herbivores.*;
import com.ivovnianko.island.classes.plants.Grass;
import com.ivovnianko.island.classes.predators.*;
...
public class ChanceToBeEatenConfig {
    private static final HashMap<String, HashMap<String, Integer>> chanceToBeEatenConfig = new HashMap<>() {{
        ...
        put(Bull.class.getName(), new HashMap<>() {{
            put(Grass.class.getName(), 100);
        }});
